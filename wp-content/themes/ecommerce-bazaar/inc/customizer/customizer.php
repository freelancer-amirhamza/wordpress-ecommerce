...
function ecommerce_bazaar_customize_register( $wp_customize ) {
    ...
    // Display Site Title
        $wp_customize->add_setting( 
            'ecommerce_bazaar_display_site_title', 
            array(
                'default'           => true,
                'type'              => 'theme_mod',
        ...
        $wp_customize->add_control( 
            new Ecommerce_Bazaar_Toggle_Control( 
                $wp_customize, 
                'ecommerce_bazaar_display_site_title', 
                array(
                    'label'    => esc_html__( 'Display Site Title', 'ecommerce-bazaar' ),
                    'section'  => 'title_tagline',
                    'settings' => 'ecommerce_bazaar_display_site_title',
                ) 
            )
        );
        ...
        $wp_customize->add_setting( 
            'ecommerce_bazaar_display_site_tagline', 
            array(
                'default'           => false,
                'type'              => 'theme_mod',
                'sanitize_callback' => 'ecommerce_bazaar_sanitize_checkbox',
        ...
        $wp_customize->add_control( 
            new Ecommerce_Bazaar_Toggle_Control( 
                ...
                'ecommerce_bazaar_display_site_tagline', 
                array(
                    'label'    => esc_html__( 'Display Tagline', 'ecommerce-bazaar' ),
                    'section'  => 'title_tagline',
                    'settings' => 'ecommerce_bazaar_display_site_tagline',
                ) 
            )
        );
