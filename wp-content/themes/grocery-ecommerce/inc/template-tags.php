...
if ( ! function_exists( 'grocery_ecommerce_posts_pagination' ) ) {
	function grocery_ecommerce_posts_pagination() {
		$grocery_ecommerce_pagination_type = get_theme_mod( 'grocery_ecommerce_pagination_type', 'page-numbers' );
		// Get custom text settings from the customizer
		$grocery_ecommerce_prev_text = get_theme_mod( 'grocery_ecommerce_blog_post_prev_nav_text', __( 'Previous', 'grocery-ecommerce' ) );
		$grocery_ecommerce_next_text = get_theme_mod( 'grocery_ecommerce_blog_post_next_nav_text', __( 'Next', 'grocery-ecommerce' ) );
		if ( $grocery_ecommerce_pagination_type == 'page-numbers' ) {
			the_posts_pagination();
		} else {
			the_posts_navigation( array(
				'prev_text' => esc_html( $grocery_ecommerce_prev_text ),
				'next_text' => esc_html( $grocery_ecommerce_next_text ),
			) );
		}
	}
}
