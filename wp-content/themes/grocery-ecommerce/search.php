                ...
                <div class="container"> 
                    <div class="row">       
                        <div class="<?php echo $grocery_ecommerce_content_col_class; ?>">
                            <h1 class="search-title text-center mb-4"><?php /* translators: %s: search term */ printf(esc_html('Search Results for: %s','grocery-ecommerce'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
