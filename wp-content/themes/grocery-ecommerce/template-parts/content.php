...
<?php 
  ...
  $alignment = get_theme_mod('grocery_ecommerce_blog_post_alignment', 'center');
?>
<article class="blog-sec blogger text-center wow zoomInLeft delay-1000 p-2 mb-4 <?php echo esc_attr($alignment); ?>-align">
  <?php if ($alignment == 'image_content') { ?>
      <div class="row m-0">
          <?php if (has_post_thumbnail()&& get_theme_mod('grocery_ecommerce_featured_image',true) == true) { ?>
